        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if (Sentinel::check()->hasAccess('user.create'))
                    ...
                    <form id="store-user-form" class="form-horizontal" role="form" method="POST"
                          action="{{url('users')}}">
                        {{ csrf_field() }}
                            ...
                            @foreach($users as $user)
                                <tr>
                                    <form action="{{ url('users/'.$user->id) }}" method="POST">
                                        ...
                                        {{ method_field('PUT') }}
                                        <td>
                                            <input type="text" name="user_{{$user->id}}_name"
                                                   id="user_{{$user->id}}_name" value="{{$user->name}}"
                                                   maxlength='255' size='20'>
                                        </td>
                                        <td>
                                            <input type="text" name="user_{{$user->id}}_email"
                                                   id="user_{{$user->id}}_email" value="{{$user->email}}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" id="update-{{ $user->id }}"
